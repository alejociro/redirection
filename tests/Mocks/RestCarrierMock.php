    ...
    public function query($requestId): FulfilledPromise
    {
        switch ($requestId) {
            ...
            case 10010:
                ...
                break;
            case 10011:
                $response = '{"requestId":10011,"status":{"status":"APPROVED","reason":"00","message":"La petición ha sido aprobada exitosamente","date":"2022-08-31T11:35:35-05:00"},"request":{"locale":"es_CO","payer":{"document":"1040035001","documentType":"CC","name":"John","surname":"Doe","email":"nuevojohn@doe.com","mobile":"3123123123"},"payment":{"reference":"test_modifiers","description":"test modifiers","amount":{"currency":"COP","total":199000},"allowPartial":false,"subscribe":false,"fields":[{"keyword":"_test_field_","value":"_test_field_value_","displayOn":"payment"}],"modifiers":[{"type":"FEDERAL_GOVERNMENT","code":17934,"additional":{"invoice":"123345"}}]},"fields":[{"keyword":"_processUrl_","value":"https://redirection.loc/session/18/334b9c19b48e4eff27e33a63f57dbeb9","displayOn":"none"}],"returnUrl":"https://mysite.com/response/32120","ipAddress":"127.0.0.1","userAgent":"PlacetoPay Sandbox","expiration":"2022-08-31T16:40:57.497Z"},"payment":[{"amount":{"to":{"total":189050,"currency":"COP"},"from":{"total":189050,"currency":"COP"},"factor":1},"status":{"date":"2022-08-31T11:35:25-05:00","reason":"00","status":"APPROVED","message":"Aprobada"},"receipt":"99963725","discount":{"base":199000,"code":"17934","type":"FEDERAL_GOVERNMENT","amount":9950,"percent":"5.0000"},"refunded":false,"franchise":"CR_VS","reference":"_test wallet","issuerName":"JPMORGAN CHASE BANK, N.A.","authorization":"000000","paymentMethod":"visa","processorFields":[{"value":"012988341","keyword":"merchantCode","displayOn":"none"},{"value":"00022645","keyword":"terminalNumber","displayOn":"none"},{"value":"411111","keyword":"bin","displayOn":"none"},{"value":"1229","keyword":"expiration","displayOn":"none"},{"value":1,"keyword":"installments","displayOn":"none"},{"value":"1111","keyword":"lastDigits","displayOn":"none"},{"value":"063136255e58a117379fddeb889f8229","keyword":"id","displayOn":"none"},{"value":"00","keyword":"b24","displayOn":"none"}],"internalReference":370581,"paymentMethodName":"Visa"}],"subscription":null}';
                break;
            default:
